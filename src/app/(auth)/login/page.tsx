    ...
    <>
      ...
      <div className="login-form">
        ...
        <form onSubmit={handleLogin}>
          ...
          <button type="submit" className="login-button mt-6">Iniciar sesión</button>
        ...
        <div className="register-link">
          <p>¿No tienes una cuenta? <Link href={`/register${redirectUrl !== '/profile' ? `?redirect=${encodeURIComponent(redirectUrl)}` : ''}`}>Regístrate</Link></p>
        </div>
      </div>
    </>
  );
